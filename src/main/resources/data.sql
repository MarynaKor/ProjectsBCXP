...
CREATE TABLE t_person_project_position (
    id SERIAL PRIMARY KEY,
    start_in_project_date TIMESTAMP,
    project_id INT,
    person_id INT
);
...
INSERT INTO t_person_project_position (project_id, person_id) VALUES ( 1,1 );
INSERT INTO t_person_project_position (project_id, person_id) VALUES ( 1,2 );
INSERT INTO t_person_project_position (project_id, person_id) VALUES ( 2,3 )